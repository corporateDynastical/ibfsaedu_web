  ...
  return (
    <div className={style.container}>
      ...
      <div className={style.logos}>
        <div className={style.company}>
          <div className={style.logo}>
            <Image src={"/logos/trispirit-01.png"} alt="" fill />
          </div>
          <h1>Trispirit Studios Private Limited</h1>
        </div>
        <div className={style.company}>
          <div className={style.logo}>
            <Image src={"/logos/tapas1.png"} alt="" fill />
          </div>
        ...
        <div className={style.company}>
          <div className={style.logo}>
            <Image src={"/logos/dynastical white-01.png"} alt="" fill />
          </div>
      ...
      <div className={style.ventures}>
        <div className={style.company}>
          <div className={style.logo}>
            <Image src={"/logos/the pune studio-01.png"} alt="" fill />
          </div>
          <h1>The Pune Studio</h1>
          <p className={didact.className}>
            The Pune Studio is a dynamic and versatile multipurpose studio with
            Pune's first-biggest Chroma Screen that has been serving the
            ...
            state-of-the-art facilities and experienced team ensure exceptional
            quality and seamless production experiences for our clients.
          </p>
        </div>
        <div className={style.company}>
          <div className={style.logo}>
            <Image src={"/logos/delilah-01.png"} alt="" fill />
          </div>
          ...
          <p className={didact.className}>
            ...
            launched establishment invites you to indulge in a delightful dining
            experience like no other. With a tastefully crafted menu featuring
            contemporary culinary innovations, our restaurant offers a
            tantalizing array of dishes to please even the most discerning
            palates. To enhance your dining experience, we feature live singing
            performances that captivate and entertain. Delilah promises a
            memorable journey through tantalizing flavors and captivating
            melodies.
          </p>
        </div>
      </div>
