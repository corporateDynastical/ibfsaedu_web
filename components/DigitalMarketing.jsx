            ...
            <div>
                <div ref={ref1} className={style.strip}>
                    <motion.h1
                        ...
                        className={`${style.title} ${didact.className}`}>Search Engine <span> Optimization </span>
                    </motion.h1>
                </div>
            ...
            <div>
                <div ref={ref2} className={`${style.strip} ${style.reverse}`}>
                    <motion.h1
                        ...
                        transition={{ duration: 1 }}
                        className={`${style.title} ${didact.className}`}>Pay Per  <span> Click </span>
                    </motion.h1>
                </div>
                ...
                <div className={style.data}>
                    <div className={style.pictureDiv}>
                        <div className={style.picture}>
                            <Image src='/assets/images/services/brand.png' alt="pay per click" fill />
                        </div>
                    </div>
            ...
            <div>
                <div ref={ref3} className={style.strip}>
                    <motion.h1
                        ...
                        transition={{ duration: 1 }}
                        className={`${style.title} ${didact.className}`}><span> Website </span>  Development
                    </motion.h1>
                </div>
