  ...
  return (
    <div className={style.container}>
      ...
      <div className={style.address}>
        <div className={lilita.className} style={{padding: "40px 30px", background: "rgba(250,250,250,0.5)", width: "max-content", margin: "40px 0", borderRadius: "20px"}}> 
          <h1 className={`${style.title} ${lilita.className}`}>our office !</h1>
          <h2 className={style.address}>Minar Apartment, Law College Road, Pune</h2>
