...
const PoliticalClientTestimonials = () => {
    ...
    return (
        <div className={style.container}>
            ...
            <div className={style.testimonials} style={{ transform: `translateX(-${index * 100}vw)` }}>
                {data.map((item, index) => {
                    return (
                        <div key={index} className={style.slideDiv}>
                            ...
                            <hr style={{ padding: "1px", margin: "30px 10vw", background: "#bbbbbb7e", boxShadow: "0px 1px 3px #000" }} />
            ...
            <div className={style.buttons}>
                <div onClick={() => { setIndex(0) }} className={`${style.button} ${index === 0 ? style.active : ''}`}></div>
                <div onClick={() => { setIndex(1) }} className={`${style.button} ${index === 1 ? style.active : ''}`}></div>
                <div onClick={() => { setIndex(2) }} className={`${style.button} ${index === 2 ? style.active : ''}`}></div>
                <div onClick={() => { setIndex(3) }} className={`${style.button} ${index === 3 ? style.active : ''}`}></div>
            </div>
