            ...
            <div>
                <div ref={ref1} className={style.strip}>
                    <motion.h1
                        ...
                        className={`${style.title} ${didact.className}`}>Image <span> Building </span>
                    </motion.h1>
                </div>
            ...
            <div>
                <div ref={ref2} className={`${style.strip} ${style.reverse}`}>
                    <motion.h1
                        ...
                        transition={{ duration: 1 }}
                        className={`${style.title} ${didact.className}`}>Election <span> Campaign </span>
                    </motion.h1>
                </div>
            ...
            <div>
                <div ref={ref3} className={style.strip}>
                    <motion.h1
                        ...
                        transition={{ duration: 1 }}
                        className={`${style.title} ${didact.className}`}><span> Post Election </span>  Campaign
                    </motion.h1>
                </div>
